...
public class ListAllActivity extends AppCompatActivity {
    ...
    private void createNewReminder(String listName) {
        Reminder reminder = new Reminder();
        reminder.reminderName = listName;
        reminder.reminderList = reminderList.id;
    ...
    public void addReminder(View view) {
        ...
        View mView = layoutInflaterAndroid.inflate(R.layout.user_input_dialog_box, null);
        TextView tv1 = mView.findViewById(R.id.dialogTitle);
        tv1.setText("Enter name of new reminder");
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(this);
        alertDialogBuilderUserInput.setView(mView);
        final EditText userInputDialogEditText = mView.findViewById(R.id.userInputDialog);
        alertDialogBuilderUserInput.setCancelable(false).setPositiveButton("Send", (dialogBox, id) -> {
            createNewReminder(userInputDialogEditText.getText().toString());
        }).setNegativeButton("Cancel", (dialogBox, id) -> dialogBox.cancel());
        AlertDialog alertDialogAndroid = alertDialogBuilderUserInput.create();
        alertDialogAndroid.show();
    }
